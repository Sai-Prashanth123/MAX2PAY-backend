-- ============================================
-- CRITICAL BUG FIXES - FINAL VERSION v3
-- Includes cancelled and delivered statuses
-- ============================================
...
-- STEP 2: Fix order statuses - keep cancelled and delivered
UPDATE orders SET status = 'pending' 
WHERE status IS NULL 
   OR status NOT IN ('pending', 'approved', 'packed', 'dispatched', 'cancelled', 'delivered');
...
-- STEP 10: Order constraints - INCLUDE cancelled and delivered
...
ALTER TABLE orders ADD CONSTRAINT chk_order_status 
  CHECK (status IN ('pending', 'approved', 'packed', 'dispatched', 'cancelled', 'delivered'));
...
-- SUCCESS
-- ============================================
SELECT '✅ MIGRATION COMPLETE - All bugs fixed!' as result;
