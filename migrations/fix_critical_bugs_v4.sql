-- ============================================
-- CRITICAL BUG FIXES - Database Layer (v4)
-- Fixed: Works with actual schema (no amount_paid column)
-- ============================================

-- STEP 1: Fix existing inconsistent inventory data
UPDATE inventory
...
-- STEP 4: Alter only columns that exist
-- Check and alter total_amount if it exists
DO $$ 
BEGIN
  IF EXISTS (
...
-- STEP 5: Add atomic inventory update function
...
-- STEP 8: Add attachment_url column
...
-- STEP 9: Remove deprecated invoiced_in field
UPDATE orders 
SET invoice_id = (
...
-- STEP 12: Inventory audit trigger
...
-- STEP 13: Safe order cancellation
